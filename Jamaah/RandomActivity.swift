...
//            NavigationStack {
                ZStack {
                    ...
                    VStack {
                        RandomActivityStar()
                        RandomActivityWheel(rotation: $rotation, showAlert: $showAlert, selectedActivity: $selectedActivity, selectedDescription: $selectedDescription, activities: Activities, navigateToDetails: $navigateToDetails)
                    }
